...
const sequelize = new Sequelize("TYQcLL35gV","TYQcLL35gV","BLysSj9ZrP",{host:'mysql-3213-0.cloudclusters.net',dialect:"mysql",logging:console.log,  port: 10021,define: {
        timestamps: false
    }
});
const db = {}
